...
from cli.src.addresses import usdt
...
def get_provider(url: str) -> Optional[Web3]:
...
def main():
    ...
    get_account_balance_from_address(web3, contract_address=usdt, account='0xcd5dc768fe61e5702ad88f3bb34ced5a30fc1b49')
...
def get_contract_from_address(web3: Web3, contract_address: str) -> Contract:
    ...
    if web3.isChecksumAddress(contract_address):
        check_sum_address = contract_address
    else:
        check_sum_address = web3.toChecksumAddress(contract_address)

    print(contract_address)
    print(check_sum_address)
    print(web3.toChecksumAddress(contract_address))  # always check sum is fine

    contract: Contract = web3.eth.contract(address=check_sum_address, abi=abi)
    return contract


def get_account_balance_from_address(web3, contract_address: str, account: str) -> None:
    ## Balance of
...
def get_contract_details(web3: Web3, contract_address: str) -> None:
    ## Details
    contract = get_contract_from_address(web3, contract_address)
...
def holders(web3: Web3, contract_address: str, n: int) -> None:
    pass
